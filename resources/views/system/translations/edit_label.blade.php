	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				<h3 class="mb-0 card-title">Add System App Group Label</h3>
			</div>
			<div class="card-body">
				<div class="row">
					<div class="col-md-3">
						<label>Select System App Group</label>
						<input type="password" class="form-control" name="example-password-input" placeholder="Select System App Group">
					</div>
					<div class="col-md-3">
						<label>Label Name</label>
						<input type="password" class="form-control" name="example-password-input" placeholder="Add Label Name...">
					</div>
					<div class="col-md-3">
						<label>English Translation</label>
						<input type="password" class="form-control" name="example-password-input" placeholder="Add English Translation...">
					</div>
					<div class="col-md-3">
						<label>Maximal length of String</label>
						<input type="password" class="form-control" name="example-password-input" placeholder="Maximum length in numbers...">
					</div>
				</div>
			</div>
			<div class="card-footer text-right">
				<button type="submit" class="btn btn-primary-light">Add Label Name</button>	
			</div>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-md-12 col-lg-12">
		<div class="card">
			<div class="card-header">
				<h2 class="card-title mb-0">Input Data Table</h2>
			</div>
			<div class="card-body">
					...
					<table id="example1" class="table table-striped table-bordered w-100 text-nowrap display">
						...
						<tbody>
							...
							<tr>
								...
								<td><select size="1" id="row-2-office" name="row-2-office" class="form-control text-dark ">
							...
							<tr>
								...
								<td><select size="1" id="row-57-office text-dark" name="row-57-office" class="form-control ">
									<option value="Edinburgh">
										Edinburgh
									</option>
									<option value="London">
